...
If you are unsure, [report it to the main repository](https://github.com/yiisoft/log-target-db/issues/new) (<https://github.com/yiisoft/log-target-db/issues>).
...
Before you report an issue, please search through [existing issues](https://github.com/yiisoft/log-target-db/issues) to see if your issue is already reported or fixed to make sure you are not reporting a duplicated issue.
